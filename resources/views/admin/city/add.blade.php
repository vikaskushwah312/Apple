      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{ url('admin/add-city') }}" id="add_city" name="add_city" method="POST">
                {{ csrf_field() }}
                <div class="box-body">
                <div class="col-md-6">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control select2" id="country_name" name="country_name">
                      ...
                      @foreach($country as $con_info)
                        <option value="{{$con_info->id}}">{{$con_info->name}}</option>
                      @endforeach
                    </select>
                    ...
                    <select class="form-control select2" id="state_name" name="state_name">
                      <option value="">Select State</option>
                       <!--@foreach($state as $state_info)
                        <option value="{{$state_info->id}}">{{$state_info->state_name}}</option>
                      @endforeach -->
                    </select>
              ...
              <div class="box-footer">
                <a href="{{url('admin/city')}}"><button type="button" class="btn btn-default">Back</button></a> 
