        ...
        <div class="col-xs-12">
            <div class="box box-primary box-solid">
                <div class="box-header box-header-background with-border">
                    ...
                    <!-- <a href="{{url('admin/add-country')}}" class="btn btn-danger pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</a> -->
                </div>

                <!-- /.box-header --> 
                <div class="box-body table-responsive">
                    <table id="owner-list-table" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>Sr.No</th>
                                <th>Name</th>
...
<script type="text/javascript">
   $(document).ready(function() {
         ...
         window.datatable = $('#owner-list-table').DataTable({
            //"order": [[ 0, "desc" ]],
            "columnDefs": [ {
