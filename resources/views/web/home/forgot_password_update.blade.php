            ...
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                    ...
                    <div class="details">
                        ...
                        <!-- Form start -->
                        <form action="{{url('post-forgot-password')}}" method="post" name="forgot_password" id="forgot_password">
                        @csrf
                            <div class="form-group">
                                <input type="text" name="email" id="email" class="input-text" placeholder="Email Address" value="{{$info->email}}" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <p class="error " id="otp">
                                  @if($errors->has('otp'))
                                    <i class="error help-block"></i> {{ $errors->first('otp') }}
                                  @endif
                                </p>
                            </div>
