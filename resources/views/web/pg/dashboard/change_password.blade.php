...
<div class="dashboard-list">
    <div class="dashboard-message contact-2">
        <form action="{{ url('pg/change-password') }}" id="change_password" name="change_password" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group subject">
                        <label>Confirm New Password <strong class="required">*</strong></label>
