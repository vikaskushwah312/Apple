...
<div class="dashboard-list">
    <div class="dashboard-message contact-2">
        <form action="{{ url('pg/complain-edit').'/'.$complain->id }}" id="complain_form" name="complain_form" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input type="text" name="subject" id="subject" placeholder="Subject" style="width: 98%" height="37px;" value="{{$complain->subject}}">
                ...
                <div class="col-sm-12">
                    ...
                    <textarea class="" id="complain" name="complain" placeholder="Complain" style="height: 240px;width: 1000px;margin-top: 0px;margin-bottom: 0px;">{{$complain->complain}}</textarea>
