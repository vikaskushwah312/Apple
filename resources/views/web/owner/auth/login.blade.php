            ...
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                    ...
                    <div class="details">
                        ...
                        <!-- Form start -->
                        <form action="{{url('owner/post-login')}}" method="post" enctype="multipart/form-data" name="login" id="login">
                            @csrf 
                    ...
                    <!-- Footer -->
                    <div class="footer">
                        <span>Don't have an account? <a href="{{url('owner/signup')}}">Register here</a></span>
                    </div>
                </div>
